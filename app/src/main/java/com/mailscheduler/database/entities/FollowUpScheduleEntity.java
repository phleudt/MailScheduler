...
public class FollowUpScheduleEntity {
    private int id;
    ...
    public FollowUpScheduleEntity(int id, int followup_number, int interval_days, int schedule_id, String schedule_category) {
        this.id = id;
